...
function oldSchool(){
    ...
    document.getElementById('htmlEH').innerText = "This is bad practice. Don't use this. "; 

}

//Traditional DOM Handler 
function tradText() {
    document.getElementById('tradiontal').innerText = "You can only attach one function to this event handler.";
}
...
function level2Text() {
    ...
    document.getElementById('level2').innerText = "You can attach one or more functions to this event hanlder."; 
}
...
function selectedChoice() {
    ...
    switch (yourChoice) {
        case "javascript":
            printCoice = "Javascript is the base for all of these.";
            break;
        case "jQuery":
